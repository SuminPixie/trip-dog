    ...
    <div id="login_box">
      <div>
        ...
        <div class="login_form">
          <form action="./act/login_check.php" id="loginForm" name="loginForm" method="post" class="needs-validation" novalidate>
            <div class="fs-4 mb-2">
        ...
        <div class="container text-center fs-5 mb-4">
          <div class="row fs-6" style="text-wrap: nowrap;">
            <div class="col border-end"><a href="javascript:void(0);" class="link-secondary">아이디 찾기</a></div>
            <div class="col border-end"><a href="javascript:void(0);" class="link-secondary">비밀번호 찾기</a></div>
